...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_hist=dict(
                type='HistogramLoss', loss_weight=5.0, features_num=features_num, directions_num=8000)),
    auxiliary_head=dict(
        type='FCNHead',
        in_channels=1024,
        in_index=2,
...
custom_hooks = [
    dict(type='HistLossHook', num_classes=num_classes, first_epoch=50, layers_num_encoder=0, layers_num_decoder=5,
...
load_from = '/home/airsim/repos/open-mmlab/mmsegmentation/results/mboaz17/deeplabv3plus/kurt_loss/r50-d8_voc12aug_GN16_AWS_BKG03/epoch_200.pth'