...
num_classes = 21
features_num = 512
conv_cfg = None  # dict(type='ConvAWS')
...
workflow = [('train', int(10)), ('val', int(1))]

custom_hooks = [
    dict(type='HistLossHook', num_classes=num_classes, first_epoch=20, layers_num_encoder=0, layers_num_decoder=5,
