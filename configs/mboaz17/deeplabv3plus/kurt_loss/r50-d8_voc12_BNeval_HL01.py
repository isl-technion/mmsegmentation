...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_hist=dict(
                type='HistogramLoss', loss_weight=0, features_num=features_num, directions_num=8000)),
    # auxiliary_head=dict(
    #     type='FCNHead',
    #     in_channels=1024,
    #     in_index=2,
...
workflow = [('train', int(2)), ('val', int(1))]
...
load_from = '/home/airsim/repos/open-mmlab/mmsegmentation/results/mboaz17/deeplabv3plus/kurt_loss/r50-d8_voc12_BNeval_HL5/epoch_50.pth'