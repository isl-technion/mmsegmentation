...
model = dict(
    ...
    backbone=dict(
        type='MixVisionTransformerHistLoss',
        loss_hist=dict(
            type='HistogramLoss', loss_weight=5.0, num_classes=num_classes),
    ),
...
# load_from = '/home/airsim/repos/open-mmlab/mmsegmentation/results/no_batchnorm/segformer_mit-b0_pathA_rew_672_448_HL5_dec_val/epoch_500.pth'

custom_hooks = [
    dict(type='HistLossHook', num_classes=num_classes, first_epoch=100, features_num=256,
         layer_validity=[0, 0, 0, 0, 1, 1, 1, 1, 1], save_interval=hist_save_interval)
]
