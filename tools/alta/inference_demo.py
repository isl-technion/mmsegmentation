...
##############################################3
    ...
    if 0:
        ...
        config_file = '/media/omek/Alta/experiments/arabella_test_post_sampling5/20220823_094529_sqrt/train_Agamim_All_val_IrYamim_Kikar/all/' + model_name + '/sqrt/trial_1/config.py'
        checkpoint_file = '/media/omek/Alta/experiments/arabella_test_post_sampling5/20220823_094529_sqrt/train_Agamim_All_val_IrYamim_Kikar/all/' + model_name + '/sqrt/trial_1/epoch_320.pth'
    else:
